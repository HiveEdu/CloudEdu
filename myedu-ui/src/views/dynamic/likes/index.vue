    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dynamic:likes:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['dynamic:likes:export']"
        >导出</el-button>
      </el-col>
    </el-row>
...
<script>
import { listLikes, getLikes, delLikes, addLikes, updateLikes, exportLikes } from "@/api/dynamic/likes";
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有动态点赞数据项?', "警告", {
          ...
          return exportLikes(queryParams);
        }).then(response => {
